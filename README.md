...
![Build Status](https://github.com/btmccarthy/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)

devops-capstone-project: Agile planning, TDD, CICD, and K8s.
